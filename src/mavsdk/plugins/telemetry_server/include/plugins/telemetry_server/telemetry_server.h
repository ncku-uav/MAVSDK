...
public:
    ...
    struct Ina219 {
        ...
        uint64_t time{uint64_t(NAN)}; /**< @brief<  Time since system start */
        float left_voltage{float(NAN)}; /**< @brief< [volts] Voltage in volts */
        float left_current{float(NAN)}; /**< @brief< [amperes] Current in amperes */
        float left_power{float(NAN)}; /**< @brief< [watts] Power in watts */
        float right_voltage{float(NAN)}; /**< @brief< [volts] Voltage in volts */
        float right_current{float(NAN)}; /**< @brief< [amperes] Current in amperes */
        float right_power{float(NAN)}; /**< @brief< [watts] Power in watts */
    };
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::Ina219& lhs, const TelemetryServer::Ina219& rhs);
