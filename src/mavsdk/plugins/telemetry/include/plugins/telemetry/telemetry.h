...
public:
    ...
    struct Ina219 {
        ...
        uint64_t time{}; /**< @brief<  Time since system start */
        float left_voltage{}; /**< @brief< [volts] Voltage in volts */
        float left_current{}; /**< @brief< [amperes] Current in amperes */
        float left_power{}; /**< @brief< [watts] Power in watts */
        float right_voltage{}; /**< @brief< [volts] Voltage in volts */
        float right_current{}; /**< @brief< [amperes] Current in amperes */
        float right_power{}; /**< @brief< [watts] Power in watts */
    };
