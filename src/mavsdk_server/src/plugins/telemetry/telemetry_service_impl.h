...
public:
    ...
    static std::unique_ptr<rpc::telemetry::Ina219> translateToRpcIna219(const mavsdk::Telemetry::Ina219 &ina219)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry::Ina219>();


            
        rpc_obj->set_time(ina219.time);
            
        
            
        rpc_obj->set_left_voltage(ina219.left_voltage);
            
        
            
        rpc_obj->set_left_current(ina219.left_current);
            
        
            
        rpc_obj->set_left_power(ina219.left_power);
            
        
            
        rpc_obj->set_right_voltage(ina219.right_voltage);
            
        
            
        rpc_obj->set_right_current(ina219.right_current);
            
        
            
        rpc_obj->set_right_power(ina219.right_power);
    ...
    static mavsdk::Telemetry::Ina219 translateFromRpcIna219(const rpc::telemetry::Ina219& ina219)
    {
        mavsdk::Telemetry::Ina219 obj;


            
        obj.time = ina219.time();
            
        
            
        obj.left_voltage = ina219.left_voltage();
            
        
            
        obj.left_current = ina219.left_current();
            
        
            
        obj.left_power = ina219.left_power();
            
        
            
        obj.right_voltage = ina219.right_voltage();
            
        
            
        obj.right_current = ina219.right_current();
            
        
            
        obj.right_power = ina219.right_power();
    ...
    grpc::Status SubscribeIna219(grpc::ServerContext* /* context */, const mavsdk::rpc::telemetry::SubscribeIna219Request* /* request */, grpc::ServerWriter<rpc::telemetry::Ina219Response>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        _lazy_plugin.maybe_plugin()->subscribe_ina219(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex](const mavsdk::Telemetry::Ina219 ina219) {

            rpc::telemetry::Ina219Response rpc_response;
        
            rpc_response.set_allocated_ina219(translateToRpcIna219(ina219).release());
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin()->subscribe_ina219(nullptr);
    ...
    grpc::Status SetRateIna219(
        grpc::ServerContext* /* context */,
        const rpc::telemetry::SetRateIna219Request* request,
        rpc::telemetry::SetRateIna219Response* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "SetRateIna219 sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->set_rate_ina219(request->rate_hz());
