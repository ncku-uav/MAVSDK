...
public:
    ...
    static std::unique_ptr<rpc::telemetry_server::Ina219> translateToRpcIna219(const mavsdk::TelemetryServer::Ina219 &ina219)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry_server::Ina219>();
    ...
    static mavsdk::TelemetryServer::Ina219 translateFromRpcIna219(const rpc::telemetry_server::Ina219& ina219)
    {
        mavsdk::TelemetryServer::Ina219 obj;
    ...
    grpc::Status PublishIna219(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::PublishIna219Request* request,
        rpc::telemetry_server::PublishIna219Response* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "PublishIna219 sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->publish_ina219(translateFromRpcIna219(request->ina219()));
