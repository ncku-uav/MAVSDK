...
static const char* TelemetryServerService_method_names[] = {
  ...
  "/mavsdk.rpc.telemetry_server.TelemetryServerService/PublishIna219",
...
TelemetryServerService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PublishIna219_(TelemetryServerService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status TelemetryServerService::Stub::PublishIna219(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishIna219Request& request, ::mavsdk::rpc::telemetry_server::PublishIna219Response* response) {
  return ::grpc::internal::BlockingUnaryCall< ::mavsdk::rpc::telemetry_server::PublishIna219Request, ::mavsdk::rpc::telemetry_server::PublishIna219Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PublishIna219_, context, request, response);
}

void TelemetryServerService::Stub::async::PublishIna219(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishIna219Request* request, ::mavsdk::rpc::telemetry_server::PublishIna219Response* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::mavsdk::rpc::telemetry_server::PublishIna219Request, ::mavsdk::rpc::telemetry_server::PublishIna219Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PublishIna219_, context, request, response, std::move(f));
}

void TelemetryServerService::Stub::async::PublishIna219(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishIna219Request* request, ::mavsdk::rpc::telemetry_server::PublishIna219Response* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PublishIna219_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::telemetry_server::PublishIna219Response>* TelemetryServerService::Stub::PrepareAsyncPublishIna219Raw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishIna219Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::mavsdk::rpc::telemetry_server::PublishIna219Response, ::mavsdk::rpc::telemetry_server::PublishIna219Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PublishIna219_, context, request);
}

::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::telemetry_server::PublishIna219Response>* TelemetryServerService::Stub::AsyncPublishIna219Raw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishIna219Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPublishIna219Raw(context, request, cq);
  result->StartCall();
  return result;
}
...
TelemetryServerService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< TelemetryServerService::Service, ::mavsdk::rpc::telemetry_server::PublishIna219Request, ::mavsdk::rpc::telemetry_server::PublishIna219Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](TelemetryServerService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mavsdk::rpc::telemetry_server::PublishIna219Request* req,
             ::mavsdk::rpc::telemetry_server::PublishIna219Response* resp) {
               return service->PublishIna219(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status TelemetryServerService::Service::PublishIna219(::grpc::ServerContext* context, const ::mavsdk::rpc::telemetry_server::PublishIna219Request* request, ::mavsdk::rpc::telemetry_server::PublishIna219Response* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
